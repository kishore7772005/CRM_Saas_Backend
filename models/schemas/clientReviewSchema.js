...
const clientReviewSchema = new mongoose.Schema(
  {
    companyId:   { type: mongoose.Schema.Types.ObjectId, ref: "Deal", required: true },
    ...
    clientHealthScore:{ type: Number, min: 0, max: 100, default: 50 },
...
export default clientReviewSchema;
